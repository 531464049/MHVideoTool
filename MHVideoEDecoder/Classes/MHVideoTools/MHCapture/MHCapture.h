...
/**
 采集数据回调-videoBuffer
 @param imageBuffer videoBuffer
 */
-(void)mhCaptureSendVideoSampleBuffer:(CVImageBufferRef)imageBuffer;

/**
 采集数据回调-audioBuffer
 @param imageBuffer audioBuffer
 */
-(void)mhCaptureSendAudioSampleBuffer:(CVImageBufferRef)imageBuffer;
